...
const applyAssociations = (sequelize) => {
  ...
  DishItem.hasOne(OrderItem, { foreignKey: { name: 'dishItemId', allowNull: false }, sourceKey: 'id' });
  OrderItem.belongsTo(DishItem, { foreignKey: { name: 'dishItemId', allowNull: false }, targetKey: 'id' });
